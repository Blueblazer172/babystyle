...
namespace Mirasvit\Search\Model\Index\Magefan\Blog\Post;
...
class Index extends AbstractIndex
{
    ...
    protected function buildSearchCollection()
    {
        ...
        $this->searcher->joinMatches($collection, 'main_table.post_id');

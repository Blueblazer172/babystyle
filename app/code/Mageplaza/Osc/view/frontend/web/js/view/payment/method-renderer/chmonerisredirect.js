...
define(
    [
        ...
        'CollinsHarper_Moneris/js/action/set-payment-method',
        'Magento_Checkout/js/action/set-billing-address'
    ],
    function (ko, $, Component, placeOrderAction,validator, additionalValidators, alert,url, selectPaymentMethodAction, checkoutData, setPaymentMethodAction,setBillingAddress) {
        'use strict';
        ...
        return Component.extend( {
            ...
            defaults: {
                template: 'CollinsHarper_Moneris/payment/chmonerisredirect',

    ...
    public function getWidgetHtml($name, $type = null, $template = null, $fieldOption = null)
    {
        switch ($name) {
            ...
            case 'gender':
                ...
                break;
            case 'country':
                $countryId = $this->getBillingDataFromSession('country_id') ?: $this->_helperConfig->getDefaultCountryId();
